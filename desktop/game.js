...
l.screen.menu = function()
{
	...
	l.write.hud('[Arrows] to move and aim', l.entities.camera.width / 2, l.entities.camera.height / 2 + fontSize, fontFamily, fontSize, colorGreen, 'center')
	l.write.hud('[Space] to shoot', l.entities.camera.width / 2, l.entities.camera.height / 2 + fontSize * 3, fontFamily, fontSize, colorGreen, 'center')
	l.write.hud('[Enter] to start', textPadding, l.entities.camera.height - fontSize - textPadding, fontFamily, fontSize, colorWhite)
...
l.screen.game = function()
{
	...
	if (l.keyboard.space)
	{
		if (canShoot)
		{
			...
			{
				l.physics.push.up('bullet' + l.object.last.bullet, bulletForce)
			}
			else if (playerDirection == 'down')
			{
				l.physics.push.down('bullet' + l.object.last.bullet, bulletForce)
			}
			else if (playerDirection == 'left')
			{
				l.physics.push.left('bullet' + l.object.last.bullet, bulletForce)
			}
			else if (playerDirection == 'right')
			{
				l.physics.push.right('bullet' + l.object.last.bullet, bulletForce)
			}
...
l.screen.gameover = function()
{
	...
	l.write.hud('[Enter] to retry', textPadding, l.entities.camera.height - fontSize - textPadding, fontFamily, fontSize, colorWhite)
}
